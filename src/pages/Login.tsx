...
import { Apple, Github, Mail, Lock } from 'lucide-react';
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm font-light text-gray-900">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <Link to="/forgot-password" className="font-light text-blue-600 hover:text-blue-500">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-light text-gray-500 hover:bg-gray-50"
              >
          ...
          <p className="mt-6 text-center text-sm font-light text-gray-600">
            ...
            <Link to="/signup" className="font-light text-blue-600 hover:text-blue-500">
              Sign up
            </Link>
          </p>
        </div>
